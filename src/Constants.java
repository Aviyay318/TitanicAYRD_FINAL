public class Constants {
    ...
    public static final String [] EMBARKED = {"All","charburgh","queenstown","southHampton"};
    ...
    public static final int BETWEEN_ELEVEN_THIRTY =2;
    public static final int HIGHER_THAN_THIRTY=3;
